...
import { Nt as capitalizeFirstLetter, Pt as toKebabCase, i as createFetch, u as isSafeUrlScheme } from "../_libs/@better-auth/core+[...].mjs";
import { n as defu } from "../_libs/defu.mjs";
import { n as getBaseURL } from "./auth-5s5ZJh8U.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/auth-client-CfxMpXhz.js
...
var CardTitle = import_react.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
	ref,
	className: cn("text-base font-semibold leading-snug text-balance", className),
	...props
}));
...
var Input = import_react.forwardRef(({ className, type, ...props }, ref) => {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
		type,
		className: cn("flex h-11 w-full rounded-md border border-input bg-card px-3 py-2 text-sm text-foreground shadow-[var(--shadow-border)] transition-[box-shadow] duration-[var(--motion-quick)] placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50", className),
		ref,
		...props
	});
});
...
var { signIn, signUp, signOut, useSession } = authClient;
//#endregion
export { CardHeader as a, Input as c, signOut as d, useSession as f, CardDescription as i, authClient as l, Card as n, CardTitle as o, CardContent as r, Field as s, Button as t, cn as u };
