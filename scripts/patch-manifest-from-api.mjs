...
// پیدا کردن کل تابع fetchManifest
const startMarker = 'async function fetchManifest(force = false): Promise<UpdateManifest | null> {';
...
const oldFunc = src.slice(startIdx, endIdx);
